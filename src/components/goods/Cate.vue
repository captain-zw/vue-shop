    ...
    <el-card>
      ...
      >
        ...
        <template slot="order" slot-scope="scope">
          <el-button size="mini" type="primary" v-if="scope.row.cat_level === 0"
            >一级</el-button
          >
          <el-button size="mini" type="warning" v-if="scope.row.cat_level === 1"
            >二级</el-button
          >
          <el-button size="mini" type="danger" v-if="scope.row.cat_level === 2"
            >三级</el-button
          >
        </template>
        <!-- 操作 -->
